 ...
 * reads through `crates/storage/build.rs`, so the two languages cannot drift. Epoch 49 is the first
 * supported library-store baseline. Earlier stores and newer unsupported
